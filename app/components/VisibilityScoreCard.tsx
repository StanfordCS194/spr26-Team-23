...
export function VisibilityScoreCard({ score }: VisibilityScoreCardProps) {
  ...
  return (
    <div className="rounded-xl border border-blue-500/30 bg-slate-950/80 p-9 shadow-[0_0_30px_rgba(37,99,235,0.12)]">
      ...
      <p className="mt-2 text-lg text-blue-100/95">Percent of prompts where your company appears.</p>
    </div>
  );
}
